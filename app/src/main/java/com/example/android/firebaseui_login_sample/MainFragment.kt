...
class MainFragment : Fragment() {
    ...
    override fun onActivityResult(requestCode: Int, resultCode: Int, data: Intent?) {
        ...
        if (requestCode == SIGN_IN_RESULT_CODE)
        {
            ...
            {
                /**
                 * If sign-in failed. If response is null, the user canceled the sign-in flow
    ...
    {
        /**
         * Give users the option to sign-in/register with their email or
         * Google account. If users choose to register with their email,
         * they will need to create a password as well.
         */
        val providers = arrayListOf(
            AuthUI.IdpConfig.EmailBuilder().build(),
            AuthUI.IdpConfig.GoogleBuilder().build(),
            // This is where you can provide more ways for users to register
            // and sign in.
            )
        /**
